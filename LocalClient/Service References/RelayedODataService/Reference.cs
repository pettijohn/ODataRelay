...
// Original file name:
// Generation date: 3/Apr/2013 6:43:43 PM
namespace LocalClient.RelayedODataService
{
    ...
    public partial class DemoService : global::System.Data.Services.Client.DataServiceContext
    {
        ...
        {
            if (typeName.StartsWith("ODataRelay.ODataReadWrite", global::System.StringComparison.Ordinal))
            {
                return this.GetType().Assembly.GetType(string.Concat("LocalClient.RelayedODataService", typeName.Substring(25)), false);
            }
            return null;
        }
        /// <summary>
        ...
        {
            if (clientType.Namespace.Equals("LocalClient.RelayedODataService", global::System.StringComparison.Ordinal))
            {
                return string.Concat("ODataRelay.ODataReadWrite.", clientType.Name);
            }
    ...
    /// <summary>
    /// There are no comments for ODataRelay.ODataReadWrite.Product in the schema.
    /// </summary>
    /// <KeyProperties>
    /// ID
    /// </KeyProperties>
    ...
    /// <summary>
    /// There are no comments for ODataRelay.ODataReadWrite.FeaturedProduct in the schema.
    /// </summary>
    /// <KeyProperties>
    /// ID
    /// </KeyProperties>
    ...
    /// <summary>
    /// There are no comments for ODataRelay.ODataReadWrite.Advertisement in the schema.
    /// </summary>
    /// <KeyProperties>
    /// ID
    /// </KeyProperties>
    ...
    /// <summary>
    /// There are no comments for ODataRelay.ODataReadWrite.Category in the schema.
    /// </summary>
    /// <KeyProperties>
    /// ID
    /// </KeyProperties>
    ...
    /// <summary>
    /// There are no comments for ComplexType ODataRelay.ODataReadWrite.Address in the schema.
    /// </summary>
    ...
    /// <summary>
    /// There are no comments for ODataRelay.ODataReadWrite.Supplier in the schema.
    /// </summary>
    /// <KeyProperties>
    /// ID
    /// </KeyProperties>
